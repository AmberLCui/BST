...
describe("findRecursively", function () {
    ...
    it("returns undefined if the node is not found", function () {
        let binarySearchTree = new BinarySearchTree();
        binarySearchTree
            .insert(15)
            .insert(20)
...
describe("remove", function () {
    ...
    it("should remove a node with two chldren and handle the children of the removed node", function () {
        var binarySearchTree = new BinarySearchTree();
        binarySearchTree
            .insert(22)
            .insert(49)
        ...
        expect(binarySearchTree.root.right.right.val).toBe(88);
        expect(binarySearchTree.root.right.right.right.left.left.val).toBe(89);
    });
});
